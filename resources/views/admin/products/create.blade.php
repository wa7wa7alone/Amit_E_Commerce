...
@section('content')
    ...
    <div class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">@lang('products.create')</h1>
            <a class="btn btn-secondary float-end clearfix" href="{{ route('admin.products.index') }}">Back to
                @lang('products.plural')</a>
        </div>
        <form class="card row g-3 my-3" method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body row">
                ...
                <div class="col-sm-12">
                    <label for="Price" class="form-label @error('name') is-invalid @enderror">@lang('Price')</label>
